...
public class RelatorioVendaFrame extends JFrame {
    ...
    private void carregarVendas() {
        ...
        if (vendas == null || vendas.isEmpty()) {
            ...
            for (Venda v : vendas) {
                sb.append("Farmácia/Destino: ").append(nullSafe(v.getComprador())).append("\n");
                ...
                sb.append("🛒 Medicamento: ").append(p != null ? nullSafe(p.getNome()) : "")
                  .append("\n")
    ...
    private void exportarPDF() {
        ...
        fileChooser.setSelectedFile(new File("relatorio_vendas.pdf"));
        ...
        try {
            ...
            Paragraph titulo = new Paragraph("Relatório de Vendas - FarmaEstoque", tituloFont);
